...
#pip install numpy==1.21.2 pandas==1.5.3 matplotlib==3.7.2 torch==1.12.1+cu113 -f https://download.pytorch.org/whl/torch_stable.html \
#  pytorch_lightning==2.0.4 mdtraj==1.9.9 biopython==1.79 wandb dm-tree einops \
#  torchdiffeq fair-esm pyemma diffusers peft seaborn lpips \
