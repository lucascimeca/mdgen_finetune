...
python ../prot_train.py --diffusion_steps 20 --batch_size 32 --save_path ~/scratch/mdgen/samples/ \
                        ...
                        --load_path ../../pretrained/ --tb True --learning_rate 1e-5  --inference ddpm \
                        --beta_start $1 --loss_batch_size 32 --replay_buffer_prob 1. \
                        --clip 0.05 --orig_scale 20 --replay_buffer uniform --wandb_track True