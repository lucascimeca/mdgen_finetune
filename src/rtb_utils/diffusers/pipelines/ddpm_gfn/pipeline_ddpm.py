...
class DDPMGFNPipeline(DiffusionPipeline):
    r"""
    ...
    def __init__(self, unet, scheduler):
        ...
        scheduler = DDPMGFNScheduler.from_config(scheduler.config)
    ...
    def __call__(
        ...
        >>> pipe = DDPMGFNPipeline.from_pretrained("google/ddpm-cat-256")
